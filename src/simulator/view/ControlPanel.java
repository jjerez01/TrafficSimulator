...
public class ControlPanel extends JPanel implements TrafficSimObserver{
	...
	private RoadsWeatherHistory roaHistory;
	...
	private void initGUI() {
		...
		botonRegClima = new JButton();
		botonRegClima.setToolTipText("registtrar el clima de una carretera");
		botonRegClima.setIcon(new ImageIcon("resources/icons/weather.png"));	
		botonRegClima.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
				roaHistory.setVisible(true);
			}});
	...
	private void enableToolBar(boolean enable) {
			...
			botonRegClima.setEnabled(enable);
	}
	...
	private void RegisterWeather() {
		...
		roaHistory = new RoadsWeatherHistory((Frame) SwingUtilities.getWindowAncestor(this));
		
		//roaHistory.open(roadMap);
